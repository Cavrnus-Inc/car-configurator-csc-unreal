...
template<> CAVRNUSCONNECTOR_API UScriptStruct* StaticStruct<FCavrnusRemoteContent>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_CavrnusConnector_Source_CavrnusConnector_Public_Types_CavrnusRemoteContent_h_Statics::ScriptStructInfo[] = {
		{ FCavrnusRemoteContent::StaticStruct, Z_Construct_UScriptStruct_FCavrnusRemoteContent_Statics::NewStructOps, TEXT("CavrnusRemoteContent"), &Z_Registration_Info_UScriptStruct_CavrnusRemoteContent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCavrnusRemoteContent), 2378978940U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_CavrnusConnector_Source_CavrnusConnector_Public_Types_CavrnusRemoteContent_h_3787846454(TEXT("/Script/CavrnusConnector"),
		nullptr, 0,
